                ...
                <div class="justify-between flex w-full">
                  ...
                  <div class="flex content-center items-center justify-between ml-2">
                      ...
                      <a href="{{ route('products.edit',['product' => $item->id]) }}">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 m-1.5" fill="none" viewBox="0 0 24 24"
                              stroke="currentColor">
                      ...
                      {{-- delete icon --}}
                      <a href="">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 m-1.5 delete-button" fill="none"
