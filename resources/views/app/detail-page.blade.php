    ...
    <div id="product-detail" class="flex content-center justify-between mx-2">
      ...
      <div id="product-desc" class="flex-auto ml-4">
        ...
        <div class="rounded-lg border border-primary-100 p-2 mt-3">
          <h3 class="text-sm italic text-primary-100">Nomer Sertifikat : 04330027980119</h3>
          <h3 class="text-sm italic text-primary-100">Expired Date : 2023-03-09 00:00:00</h3>
        </div>
        <button class="label px-3 py-1 mt-3.5 text-lg w-full bg-primary-200 text-primary-100" disabled="disabled">
