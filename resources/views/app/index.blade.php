...
@section('content')
  ...
  <div id="search-main" class="w-11/12 mb-36">
    ...
    <div class="mt-10">
      <form class="mx-1 flex flex-col justify-center" action="" method="post">
        <input class="mt-2 form-input w-full border-2 font-primary text-sm" type="text" name="product" id="product" 
          placeholder="Masukkan nama produk"
          required>
          <button class="btn w-40 mt-8 mx-auto flex items-center justify-center font-medium" type="submit" name="submit">
            Cari
            {{-- search icon --}}
            <span class="ml-2">
