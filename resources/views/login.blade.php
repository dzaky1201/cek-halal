      ...
      <div id="login-form" class="mt-10 w-11/12">
        <form action="" method="get" class="form-admin">
          ...
          <div class="form-admin mt-7 mx-2 relative">
            ...
            <img id="eye" src="{{ asset('/src/icons/eye.svg') }}" ] class="absolute top-10 right-3 cursor-pointer w-8"
              onclick="showPassword()" alt="view password">
            <img id="eye-closed" src="{{ asset('/src/icons/eye_close.svg') }}" ]
              class="absolute top-10 right-3 cursor-pointer w-8 hidden" onclick="showPassword()" alt="view password">
          </div>
